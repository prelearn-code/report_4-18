...
<div class="mt-10 grid grid-cols-2 gap-6 text-left text-[1.05rem] leading-8">

<div class="rounded-2xl border border-white/12 bg-white/5 px-6 py-5">
<div class="text-blue-300 font-bold mb-2">Part 1</div>
<div class="text-xl font-bold">研究背景与问题动机</div>
</div>

<div class="rounded-2xl border border-white/12 bg-white/5 px-6 py-5">
<div class="text-green-300 font-bold mb-2">Part 2</div>
<div class="text-xl font-bold">相关工作与本文定位</div>
</div>

<div class="rounded-2xl border border-white/12 bg-white/5 px-6 py-5">
<div class="text-yellow-300 font-bold mb-2">Part 3</div>
<div class="text-xl font-bold">系统模型与设计目标</div>
</div>

<div class="rounded-2xl border border-white/12 bg-white/5 px-6 py-5">
<div class="text-red-300 font-bold mb-2">Part 4</div>
<div class="text-xl font-bold">方案总览</div>
</div>
...
<div class="grid grid-cols-2 bg-white/6 text-[1.05rem] font-bold">
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.82rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-red-300">问题 1：</span>
    现有 <b>cross-user deduplication</b> 虽能减少存储，但与 <b>pay-as-you-go</b> 收费模式不协调，可能导致多用户为同一份数据重复付费。
  </div>
  <div class="px-5 py-4">
    <span class="font-bold text-blue-300">思路 1：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.82rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-red-300">问题 2：</span>
    多用户共享同一副本时，容易削弱<b>数据隔离</b>，同时也会增加后续管理与维护的复杂度。
  </div>
  <div class="px-5 py-4">
    <span class="font-bold text-blue-300">思路 2：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.82rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-red-300">问题 3：</span>
    单副本设计通常不利于<b>动态更新</b>和<b>所有权转移</b>，容易带来维护和归属上的问题。
  </div>
  <div class="px-5 py-4">
    <span class="font-bold text-blue-300">思路 3：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.84rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-blue-300">背景 1：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.84rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-blue-300">背景 2：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.84rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-blue-300">背景 3：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.84rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-red-300">局限 1：</span>
    传统去重主要关注“减少重复存储”，但没有充分考虑云存储中的实际收费模式。
  </div>
  <div class="px-5 py-4">
    <span class="font-bold text-blue-300">目标 1：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.84rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-red-300">局限 2：</span>
    多用户共享同一物理副本时，虽然节省空间，但会削弱<b>数据隔离</b>，也会增加后续管理复杂度。
  </div>
  <div class="px-5 py-4">
    <span class="font-bold text-blue-300">目标 2：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.84rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-red-300">局限 3：</span>
    单副本设计通常不利于<b>动态更新</b>和<b>所有权转移</b>，因为后续修改、交易和归属判断都会变得复杂。
  </div>
  <div class="px-5 py-4">
    <span class="font-bold text-blue-300">目标 3：</span>
...
<div class="grid grid-cols-3 bg-white/6 text-[1rem] font-bold">
...
<div class="grid grid-cols-3 border-t border-white/12 text-[0.8rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <div class="font-bold text-blue-300 mb-2">Data Integrity Auditing</div>
    - 关注如何验证云端数据是否仍然完整  
  ...
  <div class="px-5 py-4 border-r border-white/12">
    <div class="font-bold text-green-300 mb-2">Blockchain-Based Auditing</div>
    - 关注如何去掉对 <b>TPA</b> 的依赖  
  ...
  <div class="px-5 py-4">
    <div class="font-bold text-yellow-300 mb-2">Deduplication + Auditing</div>
    - 关注如何把存储去重与完整性审计结合起来  
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.84rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-blue-300">已有进展 1：</span>
    一些方案已经支持 cloud data 的完整性审计，也有一部分工作利用 <b>blockchain</b> 和 <b>smart contract</b> 降低了对 <b>TPA</b> 的依赖。
  </div>
  <div class="px-5 py-4">
    <span class="font-bold text-red-300">不足 1：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.84rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-blue-300">已有进展 2：</span>
    一些研究已经尝试把 <b>deduplication</b> 和 <b>auditing</b> 结合起来，以同时提升存储效率和可验证性。
  </div>
  <div class="px-5 py-4">
    <span class="font-bold text-red-300">不足 2：</span>
...
<div class="grid grid-cols-2 border-t border-white/12 text-[0.84rem] leading-6">
  <div class="px-5 py-4 border-r border-white/12">
    <span class="font-bold text-blue-300">已有进展 3：</span>
    部分方案已经考虑了去重环境下的安全性与审计正确性，功能上比传统 auditing 更进一步。
  </div>
  <div class="px-5 py-4">
    <span class="font-bold text-red-300">不足 3：</span>
...
<div class="text-[1rem] font-bold text-blue-300 mb-3">贡献一</div>
...
<div class="text-[1rem] font-bold text-green-300 mb-3">贡献二</div>
...
<div class="text-[1rem] font-bold text-yellow-300 mb-3">贡献三</div>
...
<div class="rounded-2xl border border-blue-300/30 bg-blue-300/8 px-5 py-5 text-[0.82rem] leading-6">
<div class="text-[1rem] font-bold text-blue-300 mb-3">User</div>
...
<div class="rounded-2xl border border-green-300/30 bg-green-300/8 px-5 py-5 text-[0.82rem] leading-6">
<div class="text-[1rem] font-bold text-green-300 mb-3">CSP</div>
...
<div class="rounded-2xl border border-yellow-300/30 bg-yellow-300/8 px-5 py-5 text-[0.82rem] leading-6">
<div class="text-[1rem] font-bold text-yellow-300 mb-3">Blockchain</div>
...
<div class="grid grid-cols-4 bg-white/6 text-[0.92rem] font-bold">
...
<div class="rounded-2xl border border-blue-300/30 bg-blue-300/8 px-4 py-4 text-[0.74rem] leading-6">
  <div class="text-[0.9rem] font-bold text-blue-300 mb-2">目标一 · Automatic Auditing</div>
...
<div class="rounded-2xl border border-green-300/30 bg-green-300/8 px-4 py-4 text-[0.74rem] leading-6">
  <div class="text-[0.9rem] font-bold text-green-300 mb-2">目标二 · User-Side Deduplication</div>
  <ul class="list-disc pl-5 space-y-1">
...
<div class="rounded-2xl border border-yellow-300/30 bg-yellow-300/8 px-4 py-4 text-[0.74rem] leading-6">
  <div class="text-[0.9rem] font-bold text-yellow-300 mb-2">目标三 · Mixed Auditing</div>
  <ul class="list-disc pl-5 space-y-1">
...
<div class="rounded-2xl border border-cyan-300/30 bg-cyan-300/8 px-4 py-4 text-[0.74rem] leading-6">
  <div class="text-[0.9rem] font-bold text-cyan-300 mb-2">目标四 · Data Dynamics</div>
  <ul class="list-disc pl-5 space-y-1">
...
<div class="rounded-2xl border border-purple-300/30 bg-purple-300/8 px-4 py-4 text-[0.74rem] leading-6">
  <div class="text-[0.9rem] font-bold text-purple-300 mb-2">目标五 · Ownership Transfer</div>
  <ul class="list-disc pl-5 space-y-1">
...
<div class="rounded-2xl border border-pink-300/30 bg-pink-300/8 px-4 py-4 text-[0.74rem] leading-6">
  <div class="text-[0.9rem] font-bold text-pink-300 mb-2">目标六 · Access Control</div>
  <ul class="list-disc pl-5 space-y-1">
...
<div class="grid grid-cols-4 bg-white/6 text-[0.95rem] font-bold">
...
<div class="grid grid-cols-4 border-t border-white/12 text-[0.78rem] leading-6">
  <div class="px-4 py-4 border-r border-white/12">
    <div class="font-bold text-blue-300 mb-2">上传与去重</div>
    <ul class="list-disc pl-5 space-y-1">
  ...
  <div class="px-4 py-4 border-r border-white/12">
    <div class="font-bold text-green-300 mb-2">链上审计</div>
    <ul class="list-disc pl-5 space-y-1">
  ...
  <div class="px-4 py-4 border-r border-white/12">
    <div class="font-bold text-yellow-300 mb-2">动态更新</div>
    <ul class="list-disc pl-5 space-y-1">
      <li>支持修改、插入、删除等操作</li>
  ...
  <div class="px-4 py-4">
    <div class="font-bold text-pink-300 mb-2">所有权转移</div>
    <ul class="list-disc pl-5 space-y-1">
...
<div class="text-[1rem] font-bold text-blue-300 mb-3">初始化函数：Setup</div>
...
<div class="text-[1rem] font-bold text-green-300 mb-3">初始化结果</div>
<ul class="list-disc pl-5 space-y-2">
...
<div class="max-w-[90%] mx-auto mt-5 grid grid-cols-2 gap-5">
<div class="rounded-2xl border border-blue-300/30 bg-blue-300/8 px-5 py-5 text-[0.8rem] leading-7">
<div class="text-[1rem] font-bold text-blue-300 mb-3">函数集合</div>
<ul class="list-disc pl-5 space-y-2">
...
<div class="rounded-2xl border border-green-300/30 bg-green-300/8 px-5 py-5 text-[0.8rem] leading-7">
<div class="text-[1rem] font-bold text-green-300 mb-3">模块调用关系</div>
<ul class="list-disc pl-5 space-y-2">
...
<div class="font-bold text-yellow-300 mb-2">上传阶段</div>
KeyGen<br>
Encrypt<br>
TagGen<br>
AuthGen
...
<div class="font-bold text-cyan-300 mb-2">审计阶段</div>
AuditReq<br>
ProofGen<br>
VerifyProof
</div>
...
<div class="font-bold text-pink-300 mb-2">动态维护阶段</div>
Modify<br>
Insert<br>
Delete
</div>
...
<div class="max-w-[90%] mx-auto mt-5 grid grid-cols-2 gap-5">
  ...
  <div class="rounded-2xl border border-blue-300/30 bg-blue-300/8 px-5 py-5 text-[0.8rem] leading-7">
    <div class="text-[1rem] font-bold text-blue-300 mb-3">步骤 1：文件划分与数据组织</div>
    <ul class="list-disc pl-5 space-y-2">
  ...
  <div class="rounded-2xl border border-green-300/30 bg-green-300/8 px-5 py-5 text-[0.8rem] leading-7">
    <div class="text-[1rem] font-bold text-green-300 mb-3">步骤 2：公开数据与私密数据分离</div>
    <ul class="list-disc pl-5 space-y-2">
...
<div class="max-w-[90%] mx-auto mt-5 grid grid-cols-3 gap-4">
  ...
  <div class="rounded-xl border border-yellow-300/30 bg-yellow-300/8 px-4 py-3 text-[0.76rem] leading-6">
    <div class="font-bold text-yellow-300 mb-2">文件级表示</div>
    <div>F = F₁ ∪ F₂</div>
    <div class="mt-2">公开数据与私密数据先分离，再分别处理</div>
  </div>

  <div class="rounded-xl border border-cyan-300/30 bg-cyan-300/8 px-4 py-3 text-[0.76rem] leading-6">
    <div class="font-bold text-cyan-300 mb-2">块级表示</div>
    <div>F = {mᵢ}</div>
    <div class="mt-2">每个 mᵢ 对应一个数据块</div>
  </div>

  <div class="rounded-xl border border-pink-300/30 bg-pink-300/8 px-4 py-3 text-[0.76rem] leading-6">
    <div class="font-bold text-pink-300 mb-2">sector 级表示</div>
    <div>F = {mᵢ,ⱼ}</div>
...
::CardBox
<div class="text-[1rem] font-bold text-blue-300 mb-3">步骤 3：密钥生成与私密块加密</div>
...
::CardBox
<div class="text-[1rem] font-bold text-green-300 mb-3">步骤 4：标签构造与认证准备</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1">文件密钥</div>
...
::CardBox
<div class="font-bold text-cyan-300 mb-1">sector key</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1">块标签</div>
...
::CardBox
<div class="text-[0.96rem] font-bold text-blue-300 mb-3">步骤 5：身份绑定与认证请求</div>
...
::CardBox
<div class="text-[0.96rem] font-bold text-green-300 mb-3">步骤 6：CSP 先验身份，再做两级去重</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-2">唯一块参数</div>
...
::CardBox
<div class="font-bold text-cyan-300 mb-2">authenticator</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-2">一致性验证</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-blue-300 mb-2">步骤 7：唯一块上传与本地保留信息</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-green-300 mb-2">步骤 8：构造增强型 MHT</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1">节点三元组</div>
...
::CardBox
<div class="font-bold text-cyan-300 mb-1">链上存储信息</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1">保证金</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-blue-300 mb-2">步骤 1：用户发起审计请求</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-green-300 mb-2">步骤 2：合约生成挑战</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1">挑战索引生成</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1">挑战权重生成</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-blue-300 mb-2">步骤 3：CSP 根据挑战定位被审计块</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-green-300 mb-2">步骤 4：按 sector 聚合生成审计证明</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1">挑战输入</div>
...
::CardBox
<div class="font-bold text-cyan-300 mb-1">证明向量</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1">单个分量</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-blue-300 mb-2">步骤 5：聚合认证器生成</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-green-300 mb-2">步骤 6：链上执行证明验证</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1">链上记录结果</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1">费用结算规则</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-blue-300 mb-2">步骤 1：用户发起数据检索请求</div>
...
::CardBox
<div class="text-[0.9rem] font-bold text-green-300 mb-2">步骤 2：返回数据与密钥密文</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1">私密 sector 解密</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1">文件恢复结果</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-blue-300 mb-1">步骤 1：用户发起插入请求</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-green-300 mb-1">步骤 2：CSP 认证身份并执行去重检查</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-0 text-[0.86rem]">新块参数生成</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-0 text-[0.86rem]">新块认证器</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-blue-300 mb-2">步骤 3：CSP 执行插入并更新存储状态</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-green-300 mb-2">步骤 4：MHT 重计算与链上提交</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1 text-[0.82rem]">更新结果</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1 text-[0.82rem]">图示位置</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-blue-300 mb-2">批量插入：用户侧处理</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-green-300 mb-2">批量插入：CSP 执行与链上记录</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1 text-[0.82rem]">修改操作</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1 text-[0.82rem]">删除操作</div>
...
::CardBox
<div class="text-[0.82rem] font-bold text-blue-300 mb-1">步骤 1：买方发起交易请求</div>
...
::CardBox
<div class="text-[0.82rem] font-bold text-green-300 mb-1">步骤 2：原拥有者提交身份信息并触发所有者更新</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-0 text-[0.82rem]">CSP 身份验证</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-0 text-[0.82rem]">更新后链上记录</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-blue-300 mb-2">步骤 3：原拥有者交付密钥并接收交易费用</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-green-300 mb-2">步骤 4：新拥有者发起访问并验证密钥正确性</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-0 text-[0.82rem]">身份验证与解密判定</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-0 text-[0.82rem]">结算结果</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-blue-300 mb-2">对比对象与评估内容</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-green-300 mb-2">实验平台与实现环境</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1 text-[0.82rem]">链下实验参数</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1 text-[0.82rem]">密码与统计设置</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-blue-300 mb-2">图示结果</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-green-300 mb-2">结果解读</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1 text-[0.82rem]">优势来源</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1 text-[0.82rem]">核心结论</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1 text-[0.82rem]">实验设置</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-0 text-[0.82rem]">核心结论</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1 text-[0.82rem]">开销特征</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-blue-300 mb-2">链下实验总结</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-green-300 mb-2">链上实验总结</div>
...
::CardBox
<div class="font-bold text-yellow-300 mb-1 text-[0.82rem]">综合优势</div>
...
::CardBox
<div class="font-bold text-pink-300 mb-1 text-[0.82rem]">实验结论</div>
...
::CardBox
<div class="text-[0.86rem] font-bold text-green-300 mb-2">论文结论</div>
